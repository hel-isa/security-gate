...
- `v2.0.0`: exact release, recommended for approved consumers
- `v2.0.1`: patch release for compatible fixes
...
- workflow reference: `@v2.0.0`
- dashboard/script reference: `gate_ref: v2.0.0`
